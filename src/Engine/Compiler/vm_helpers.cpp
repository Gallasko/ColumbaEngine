...
namespace pg
{
    ...
    void VM::register_builtin_operations()
    {
        ...
        register_operation(static_cast<uint8_t>(OpCode::OP_Jump_If_False_Popping), op_jump_if_false);
        register_operation(static_cast<uint8_t>(OpCode::OP_Long_Jump_If_False), op_long_jump_if_false);
        register_operation(static_cast<uint8_t>(OpCode::OP_Long_Jump_If_False_Popping), op_long_jump_if_false);
