...
public:
    ...
    // Poll the inventory UI's visibility each tick to keep both panels in
    // lockstep (TAB, click-outside-to-close, etc. all funnel through the
    // inventory UI). Also refreshes the progress bar + row colors.
